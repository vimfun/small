...
@desc_it
def metric(instance_ids, period=300, name="CPUUtilization", namespace="acs_ecs_dashboard"):
...
if __name__ == '__main__':
    ...
    res = get_metric_infos([instance_id], name=metric_name, namespace=namespace_name)
